...
describe BooksController do
  describe "routing" do
    ...
    it "routes to #mass_edit" do
      post("/books/mass_edit").should route_to("books#mass_edit")
    end

    it "routes to #mass_update" do
      put("/books/mass_update").should route_to("books#mass_update")
    end
